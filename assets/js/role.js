$(document).ready(function () {
    ...
    $('body').on('click', '.akses', function () {
        var id = $(this).data('id');
        $('#role_id').val(id);
        $('#aksesForm input[type="checkbox"]').not('#aksesAll').prop('checked', false);
        ...
        $.get(BASE_URL + "Role/get_akses/" + id, function (res) {
            ...
            akses.forEach(function (a) {
                $('#aksesForm input[type="checkbox"][value="' + a + '"]').prop('checked', true);
            });

            // Update checkbox ALL
            var total = $('#aksesForm input[type="checkbox"]').not('#aksesAll').length;
            var checked = $('#aksesForm input[type="checkbox"]:checked').not('#aksesAll').length;
    ...
    $('#aksesForm input[type="checkbox"]').not('#aksesAll').on('change', function () {
        var total = $('#aksesForm input[type="checkbox"]').not('#aksesAll').length;
        var checked = $('#aksesForm input[type="checkbox"]:checked').not('#aksesAll').length;
        $('#aksesAll').prop('checked', total === checked);
    });
